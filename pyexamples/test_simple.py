...
arch = [
    ...
    to_Conv("layer_norm", 768, 64, offset="(0,0,0)", to="(0,0,0)", height=20, depth=20, width=3, caption=""),

    # 🔹 Small Down Projection (Bottleneck Start)
    to_Conv("down_proj", 256, 32, offset="(1.5,0,0)", to="(layer_norm-east)", height=10, depth=10, width=1.5, caption=""),
    to_connection("layer_norm", "down_proj"),

    # 🔹 Small Multi-Head Attention (Bottleneck Processing)
    to_Attention("attention", s_filer=256, offset="(1.5,0,0)", to="(down_proj-east)", height=10, depth=10, width=1.5, caption=""),
    to_connection("down_proj", "attention"),

    # 🔹 Large Up Projection (Decoder)
    to_Conv("up_proj", 768, 64, offset="(1.5,0,0)", to="(attention-east)", height=20, depth=20, width=3, caption=""),
