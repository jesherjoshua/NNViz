...
arch = [
    ...
    to_Conv("conv1", offset="(0,0,0)", to="(0,0,0)", height=16, depth=16, width=2),  # Patch Embedding
    to_Pool("pool1", offset="(0,0,0)", to="(conv1-east)", height=14, depth=14, width=1),  # Simulating Pooling

    # Transformer Blocks (simplified)
    to_Conv("conv2", offset="(1,0,0)", to="(pool1-east)", height=14, depth=14, width=2),  # Self-attention layer
    to_Pool("pool2", offset="(0,0,0)", to="(conv2-east)", height=12, depth=12, width=1),  # Pooling layer
    
    to_Conv("conv3", offset="(1,0,0)", to="(pool2-east)", height=12, depth=12, width=2),  # Feed-forward layer
